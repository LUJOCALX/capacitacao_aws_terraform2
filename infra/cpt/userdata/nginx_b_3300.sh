...
# habilita o balanceamento para os servidores APACHE nas portas 3001,3002 e desabilita
...
sudo cp /home/ubuntu/default3300 /etc/nginx/sites-enabled/default
sudo chmod 644 /etc/nginx/sites-enabled/default
sudo rm /home/ubuntu/default3300
